...
navigate to folder you want the repo to end up in and clone it
```
cd folder_of_choice/
...
or: 
```
python generate_ground_truth.py --input-dir path_to_data/
```

or if you want to reannotate already annotated images: 
```
python generate_ground_truth.py --redo
```
